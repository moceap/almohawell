...
Almohawell::Package::Pkg - an object that represents a Solaris pkg package

=cut

package Almohawell::Package::Pkg;
use strict;
...
It is derived from Almohawell::Package.
...
#  	closedir DIR;
	...
	print PKGINFO qq{VENDOR="Almohawell-converted package"\n};
	print PKGINFO qq{EMAIL=\n};
	print PKGINFO qq{PSTAMP=almohawell\n};
